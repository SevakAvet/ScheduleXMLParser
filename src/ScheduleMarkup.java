...
public class ScheduleMarkup {
	...
	public ScheduleMarkup(String[][] table, Object[] numeratorData, Object[] denominatorData) {
		this.table = table;
	...
	public static void printSchedule() {
		System.out.println(scheduleFormat);
	}
	...
	public static String getFormattedTable(String[][] table) {
		return String.format(ScheduleMarkup.tableFormat, getTableStrings(table));
	}
